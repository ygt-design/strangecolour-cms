// Keep in sync with strangecolor-web/src/pages/Current/layoutConfig.js
...
/**
 * Convert v3 row to 1-based [{ start, span }] for grid placement.
 */
...
/**
 * Scale a v3 row from 12 cols to a different column count (e.g. 8 for tablet).
 */
